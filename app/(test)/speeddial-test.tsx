                    ...
                    <XStack gap="$4" flexWrap="wrap">
                        <Card flex={1} minWidth={250} elevate bordered padding="$4">
                            ...
                            <YStack gap="$1">
                                ...
                                <Text fontSize="$2">Actions: <Text
                                    fontWeight="bold">{getActionsForVariant().length}</Text></Text>
                                <Text fontSize="$2">Mode: <Text
                                    fontWeight="bold">{isControlled ? 'Controlled' : 'Uncontrolled'}</Text></Text>
                            </YStack>
                        </Card>
